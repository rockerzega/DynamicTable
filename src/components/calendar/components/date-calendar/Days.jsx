    ...
    <div className="grid grid-cols-7 my-1" style={{rowGap: '0.125rem'}}>
      {calendarData.days.previous.map((item, index) => (
        <button
          ...
          onMouseOver={() => {
            console.log(`Has pasado por el boton ${item} en previous`)
      ...
      {calendarData.days.current.map((item, index) => (
        <button
          ...
          onMouseOver={() => {
            console.log(`Has pasado por el boton ${item} en current`)
      ...
      {calendarData.days.next.map((item, index) => (
        <button
          ...
          onMouseOver={() => {
            console.log(`Has pasado por el boton ${item} en next`)
            hoverDay(item, "next");
          }}
        >
          {item}
